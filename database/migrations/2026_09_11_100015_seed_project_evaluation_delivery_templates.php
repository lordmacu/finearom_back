...
{
    /**
     * Templates de la entrega del área Evaluaciones (modal notas + adjuntos).
  ...
  Correo automático de la plataforma Finearom. La lista de destinatarios se administra en Configuración → Procesos ("Proyecto: entrega evaluaciones"; si está vacía, se usa la de "Proyecto: creación").
</p>';
        ...
        $variables = json_encode([
            ...
            'delivered_by'   => 'Usuario que entregó/actualizó evaluaciones',
            'notas_entrega'  => 'Notas escritas en el modal de entrega',
        ...
        if (!DB::table('email_templates')->where('key', 'project_evaluation_delivered')->exists()) {
            DB::table('email_templates')->insert([
                'key'  => 'project_evaluation_delivered',
                'name' => 'Proyecto: entrega evaluaciones',

                'subject' => 'Evaluaciones listas — proyecto #|project_id| — |project_name| · |client_name|',

                'title' => 'Evaluaciones listas',

                'header_content' => '
<p>Hola equipo,</p>
<p><strong>|delivered_by|</strong> entregó las evaluaciones del proyecto
...
' . $button,
        ...
        if (!DB::table('email_templates')->where('key', 'project_evaluation_updated')->exists()) {
            DB::table('email_templates')->insert([
                'key'  => 'project_evaluation_updated',
                'name' => 'Proyecto: actualización de evaluaciones',

                'subject' => 'Evaluaciones actualizadas — proyecto #|project_id| — |project_name| · |client_name|',

                'title' => 'Evaluaciones actualizadas',

                'header_content' => '
<p>Hola equipo,</p>
<p><strong>|delivered_by|</strong> actualizó las evaluaciones del proyecto
<strong>|project_name|</strong> para <strong>|client_name|</strong>.</p>
