...
<body style="font-family:Arial,sans-serif;color:#333333;line-height:1.6;margin:0;padding:20px;font-size:13px;background-color:#ffffff;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:700px;margin:0 auto;border:none;">
        <tr>
            <td style="padding-bottom:20px;border-bottom:2px solid #1F2345;border-left:none;border-right:none;border-top:none;">
        ...
        @if(!empty($title))
        <tr>
            <td style="padding:30px 0 20px 0;border:none;">
        ...
        <tr>
            <td style="padding-top:30px;border-top:1px solid #d6d8d8;border-left:none;border-right:none;border-bottom:none;font-size:13px;">
                @if(!empty($signature))
