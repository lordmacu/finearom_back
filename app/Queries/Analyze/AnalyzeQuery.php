            ...
            return $base
                ...
                ->selectRaw('
                    SUM(
                        ...
                        (CASE
                            WHEN purchase_orders.trm IS NOT NULL AND purchase_orders.trm >= 2500 THEN purchase_orders.trm
        ...
        return $base
            ...
            ->selectRaw('
                SUM(
                    ...
                    partials.quantity *
                    (CASE
                        WHEN partials.trm IS NOT NULL AND partials.trm >= 2500 THEN partials.trm
                        WHEN trm_daily.value IS NOT NULL THEN trm_daily.value
                        ELSE 4000
                    END)
                ) as total_cop
    ...
    public function clientPartials(
        ...
        if ($type === 'temporal') {
            ...
            return $base
                ...
                ->selectRaw('
                    (CASE
                        WHEN purchase_orders.trm IS NOT NULL AND purchase_orders.trm >= 2500 THEN "no"
                        ELSE "si"
                    END) as defaultTrm
                ')
        ...
        return $base
            ...
            ->selectRaw('
                (CASE
                    WHEN partials.trm IS NOT NULL AND partials.trm >= 2500 THEN "no"
                    ELSE "si"
                END) as defaultTrm
            ')
            ->selectRaw('purchase_order_product.muestra as is_muestra')
